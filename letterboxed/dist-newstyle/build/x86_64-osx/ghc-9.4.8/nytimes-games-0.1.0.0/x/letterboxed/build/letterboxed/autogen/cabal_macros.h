...
/* package nytimes-games-0.1.0.0 */
#ifndef VERSION_nytimes_games
#define VERSION_nytimes_games "0.1.0.0"
#endif /* VERSION_nytimes_games */
#ifndef MIN_VERSION_nytimes_games
#define MIN_VERSION_nytimes_games(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_nytimes_games */
...
#define CURRENT_COMPONENT_ID "nytimes-games-0.1.0.0-inplace-letterboxed"
